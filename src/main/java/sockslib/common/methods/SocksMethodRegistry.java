 ...
 * <p>
 * This class can register some {@link SocksMethod} classes and provide a method { {@link
 * #getByByte(byte)} to return a {@link SocksMethod} class which value is equal the given byte.
 * </p>
 *
 * @author Youchao Feng
 * @version 1.0
...
public class SocksMethodRegistry {
  ...
  /**
   * Puts a {@link SocksMethod} class into the SOCKS method registry with an instance of {@link
   * SocksMethod}.
   *
