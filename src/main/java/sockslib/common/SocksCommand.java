...
/**
 * The enumeration <code>SocksCommand</code> represents SOCKS command.<br> SOCKS4 protocol support
 * CONNECT and BIND, SOCKS5 protocol supports CONNECT, BIND, and UDP ASSOCIATE.
 *
 * @author Youchao Feng
 * @version 1.0
